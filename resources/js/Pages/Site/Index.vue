...
.imagem {
    max-width: 100%;/* Define a largura máxima da imagem como 100% do contêiner */
    height: 139px;
    max-height: 139px; /* Mantém a proporção da imagem */
    display: flex; /* Garante que a imagem respeite as margens */
}
